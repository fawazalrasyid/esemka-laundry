...
$query = "SELECT * FROM outlet WHERE id_outlet  = " . $_GET['id'];
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="first-name-vertical" class="form-control" name="nama_outlet" value="<?= $edit['nama_outlet']; ?>" placeholder="Outlet">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group mb-3">
                                                <label for="exampleFormControlTextarea1" class="form-label">Alamat
                                                    Outlet</label>
                                                <textarea class="form-control" id="exampleFormControlTextarea1" name="alamat_outlet" rows="3"><?= $edit['alamat_outlet']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="contact-info-vertical">No Telepon</label>
                                                <input type="number" id="contact-info-vertical" class="form-control" name="telp_outlet" value="<?= $edit['telp_outlet']; ?>" placeholder="No Telp">
                                            </div>
                                        </div>
