                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 mt-3">
                            <div class="white-box">
                                ...
                                <div class="row justify-content-center align-items-center">
                                    <lottie-player src="https://assets10.lottiefiles.com/packages/lf20_udsg68fb.json"
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center mb-5">
                                        ...
                                        <h3><strong>Total Pembayaran
                                                <?= 'Rp ' . number_format($data['total_harga']); ?></strong><br></h3>
                                        <h3><strong>Total Uang Bayar
                                                <?= 'Rp ' . number_format($data['total_bayar']); ?></strong><br></h3>
                                        <h3><strong>Kembalian
                                                <?= 'Rp ' . number_format($data['total_bayar'] - $data['total_harga']); ?></strong><br><br>
                                        </h3> -->
                                        <br>
                                        <br>
